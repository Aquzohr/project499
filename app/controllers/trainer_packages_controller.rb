  ...
  def create
    ...
    respond_to do |format|
      if @trainer_package.save
        format.html { redirect_to @trainer_package, notice: 'Trainer package was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @trainer_package.update(trainer_package_params)
        format.html { redirect_to @trainer_package, notice: 'Trainer package was successfully updated.' }
